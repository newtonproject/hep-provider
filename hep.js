...
var hep = {};
hep.auth = {};
hep.auth.login = function(params, callback) {
    bridge.call(REQUEST_PROFILE, params,function (profile) {
        callback(profile);
    })
};
hep.pay = {};
hep.pay.order = function(params, callback){
    bridge.call(REQUEST_PAY, params, function (pay_info) {
        callback(pay_info);
    });
};
